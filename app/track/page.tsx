...
export default function TrackDelivery () {
    return (
        ...
        <div className="flex justify-center items-start mt-8 gap-2">
          ...
          <p>Note that the type of delivery you <br/> you requested determines when <br/> package is delivered </p>
        </div>
      </div>
            <div className="flex w-full max-w-sm items-center space-x-2 justify-center">
            <Input type="text" placeholder="Tracking Number" className="w-48 border-2 border-slate-400"/>
