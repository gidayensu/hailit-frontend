  ...
  return (
    <>
      <div className="container mx-auto py-8">
        ...
        <p className="mb-4">
          Welcome to Hailit Inc.&#39;s Privacy Policy. Your privacy is important
        ...
        <p className="mb-4">
          ...
          you use our services. This may include your name, address, email
          address, phone number, payment information, and any other information
        ...
        <p className="mb-4">
          ...
          Privacy Policy or as required by law. We may share your information
          with:
        </p>
        <ul className="list-disc pl-6 mb-4">
          <li>Service providers who help us deliver our services;</li>
          <li>Third-party partners for marketing and advertising purposes;</li>
          <li>
        ...
        <p className="mb-4">
          ...
          updated Privacy Policy on our website. You are advised to review this
          Privacy Policy periodically for any changes.
        </p>

        <p>
          If you have any questions or concerns about our Privacy Policy, please
          contact us at privacy@hailit.com.
        </p>
      </div>
    </>
  );
