    ...
    return (
        ...
        <Container className="flex  w-5/6 h-44 rounded-xl p-4 gap-2">
                <div className="flex flex-col items-center justify-center gap-3 w-1/2">
                       ...
                       {
                                 isLoading  && !error ? <Loader color="primary"/> : error ? <p className="text-red-500" >Error occurred</p> :
                ...
                <div className="flex flex-col items-center justify-center gap-3 w-1/2">
                        ...
                        {
                            isLoading ? <Loader color="primary"/> : error ? <p className="text-red-500">Error occurred</p> :
