...
export default function MapModal({
  ...
  return (
    <dialog
      ref={modalRef}
      className="animate-in zoom-in duration-100  ease-in-out  w-2/3 md:w-1/4  rounded-2xl h-[360px]  p-4  backdrop:bg-secondary-dark backdrop:opacity-80"
    >
      ...
      <div>
        <div className="flex items-center justify-center mb-2 -mt-4 md:-mt-0">
          <Image src={current_location} width={80} alt="" />
        </div>
        <div className="flex items-center justify-center">
          <div className="flex flex-col  gap-2 w-full">
            <div className="">
              <h2 className="text-center leading-5 text-sm mb-2 animate-in slide-in-from-bottom duration-100">
                Set <b>{mapLocationName}</b> as your {locationType} location
              </h2>
              <h3 className="text-center text-[12px] text-slate-500 animate-in slide-in-from-bottom duration-150">
                This is where your item will be
                {locationType === "drop off" ? "delivered" : "picked up"}
              </h3>
            ...
            <div className="mt-4 w-full flex flex-col gap-2 items-center justify-center">
              ...
              >
                ...
                {loading ? (
                  <LoaderCircle className="animate-spin text-white dark:text-secondary-dark " />
                ) : (
                  "Confirm"
                )}
              </Button>
